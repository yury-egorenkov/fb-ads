...
func TestGetCampaignsToTerminate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			minImpressions: 1000,
			campaigns: []CampaignPerformance{
				{CampaignID: "1", Impressions: 500},
				{CampaignID: "2", Impressions: 800},
				{CampaignID: "3", Impressions: 600},
			},
			expected: []string{},
		},
		{
			...
			minImpressions: 1000,
			campaigns: []CampaignPerformance{
				{CampaignID: "1", Impressions: 1200},
				{CampaignID: "2", Impressions: 800},
				{CampaignID: "3", Impressions: 1500},
				{CampaignID: "4", Impressions: 600},
			},
			expected: []string{"2", "4"},
		},
		{
...
func TestGetUnderperformingCampaigns(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			campaigns: []CampaignPerformance{
				{CampaignID: "1", Impressions: 1200, CPC: 2.0},
				{CampaignID: "2", Impressions: 1500, CPC: 2.5},
				{CampaignID: "3", Impressions: 1800, CPC: 3.0},
			},
			expected: []string{},
		},
		{
...
func TestCalculateMedian(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			values:   []float64{9.0, 1.0, 5.0, 3.0, 7.0},
			expected: 5.0,
		},
	}
